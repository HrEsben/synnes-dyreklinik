...
const availableIcons = [
  ...
  { name: 'Scissors', icon: Scissors, label: 'Saks' },
  { name: 'Tag', icon: Tag, label: 'Mærke' },
  { name: 'Cat', icon: Cat, label: 'Kat' },
  { name: 'Dog', icon: Dog, label: 'Hund' },
  { name: 'Smile', icon: Smile, label: 'Smil' },
  ...
  { name: 'Droplet', icon: Droplet, label: 'Dråbe' },
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
      <div className="flex items-center justify-between mb-4">
        <h2 className="text-xl font-semibold text-gray-900">Administrer ydelser</h2>
      </div>
