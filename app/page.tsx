  ...
  <div className="flex flex-col md:flex-row justify-between mx-6">
    <div className="flex flex-row md:flex-col lg:flex-row mb-12 md:mb-0">
      <div className="mr-9 lg:mr-6 mb-0 md:mb-5 lg:mb-0">
        <Image src="/icons/letter-icon.svg" alt="Kontakt klinikken" width={80} height={78} /></div>
      <div>
    ...
    <div className="flex flex-row md:flex-col lg:flex-row mb-12 md:mb-0">
      <div className="mr-9 lg:mr-6 mb-0 md:mb-5 lg:mb-0">
        <Image src="/icons/clock-icon.svg" alt="Åbningstider" width={80} height={78} /></div>
      <div>
    ...
    <div className="flex flex-row md:flex-col lg:flex-row mb-0">
      <div className="mr-9 lg:mr-6 mb-0 md:mb-5 lg:mb-0">
        <Image src="/icons/map-pin-icon.svg" alt="Kontakt klinikken" width={80} height={78} /></div>
      <div>
      ...
      <section className="py-25 px-6 bg-[#fffaf6]">
        <div className="flex flex-col lg:flex-row items-center justify-center">
          <div className="order-2 lg:order-1">
            <Image src={"/images/synneanddog.jpg"} width={488} height={574} alt="Synne og hund" className="rounded-4xl -rotate-4"/>
          </div>
        ...
        <div className="max-w-[310px]">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="md:col-span-2">
              <Image src={"/logo.svg"} alt="Synnes dyreklinik" width={120} height={50} className="mb-4"/>
